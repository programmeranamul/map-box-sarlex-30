...
export default function App() {
  ...
  return (
    <div
      className={`app-container ${isScreenshotMode ? "screenshot-mode" : ""}`}
      ...
      <div className="left-panel">
        ...
        <section>
          ...
          <div className="color-options">
            {Object.entries(customStyles).map(([key, style]) => (
              <div
                key={key}
                className={`color-dot ${
  ...
  <div
    className={`map-inner ${
      mapSize === "Polaroid" ? "size-preset-polaroid" : ""
    } ${mapSize === "Instax Mini" ? "size-preset-instax" : ""}`}
    ref={mapRef}
    style={{
      "--map-aspect": sizePresets[mapSize].aspectRatio,
      "--forced-width": `363.8125px`,
      "--forced-height": `514.5499877929688px`,
      position: "relative", // Make it the reference for absolute elements
    }}
  >
    {/* Label outside map */}
